...
import { Search, ShoppingCart, Menu, X, LogIn, LogOut, ShieldCheck, Eye, EyeOff, AlertCircle } from "lucide-react";
...
export function Navbar({ onSearch }: NavbarProps) {
  ...
  return (
    <>
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              {isAdmin ? (
                <div className="hidden sm:flex items-center gap-2">
                  <span className="flex items-center gap-1.5 text-xs font-semibold text-emerald-400 bg-emerald-400/10 border border-emerald-400/30 px-3 py-1.5 rounded-md">
                    <ShieldCheck className="h-3.5 w-3.5" /> Admin
                  </span>
                  <Button variant="ghost" size="sm" onClick={logout}
                    className="text-white/60 hover:text-white hover:bg-white/10 text-xs h-9 gap-1.5"
                ...
                <Button
                  ...
                  onClick={() => { setLoginOpen(true); setLoginError(""); setLoginUser(""); setLoginPass(""); }}
      ...
      {/* B2B Login Modal */}
      <Dialog open={loginOpen} onOpenChange={(open) => { setLoginOpen(open); if (!open) { setLoginError(""); setLoginUser(""); setLoginPass(""); } }}>
        <DialogContent className="sm:max-w-[400px]" data-testid="dialog-login">
          <DialogHeader>
            <div className="flex items-center gap-3 mb-1">
              ...
              <div>
                <DialogTitle className="text-xl font-bold leading-tight">Admin Login</DialogTitle>
                <p className="text-xs text-gray-500 mt-0.5">Veer Mahadev Plastic — Owner Portal</p>
              </div>
            </div>
          </DialogHeader>
          ...
          >
            <div className="space-y-1.5">
              ...
              <Input
                ...
                className={`h-11 ${loginError ? "border-red-400 focus-visible:ring-red-300" : "focus-visible:ring-amber-300"}`}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`h-11 pr-10 ${loginError ? "border-red-400 focus-visible:ring-red-300" : "focus-visible:ring-amber-300"}`}
            ...
            <Button
              ...
              className="w-full h-11 bg-gray-900 hover:bg-gray-800 font-semibold disabled:opacity-50"
            ...
            <p className="text-xs text-center text-gray-400 pt-1">
              This portal is restricted to authorised owners only.
            </p>
          </form>
        </DialogContent>
      </Dialog>
